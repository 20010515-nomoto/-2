...
CMatrix CMatrix::operator*(const float &f){
	...
	t.mM[0][0] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[0][1] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[0][2] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[0][3] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;

	t.mM[1][0] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[1][1] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[1][2] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[1][3] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;

	t.mM[2][0] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[2][1] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[2][2] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[2][3] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;

	t.mM[3][0] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[3][1] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[3][2] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
	t.mM[3][3] = mM[0][0] * f + mM[0][1] * f + mM[0][2] * f + mM[0][3] * f;
